...
import static eu.phiwa.dt.movement.Waypoint.markers;


import eu.phiwa.dt.anticheat.DragonTravelAntiCheat;
import eu.phiwa.dt.commands.Commands;
import eu.phiwa.dt.economy.EconomyHandler;
import eu.phiwa.dt.listeners.*;
import eu.phiwa.dt.modules.ConfigurationLoader;
import eu.phiwa.dt.modules.DatabaseLoader;
...
public class DragonTravelMain extends JavaPlugin {
	...
	public static Double ver = 1.6; // IMPORTANT

	// Messages
	public static File messagesFile; // Config erstellen
	public static FileConfiguration messages;
	public static Double messagesVer = 0.7; // IMPORTANT
	...
	// Required Item
	public static boolean requireItem = false;
	...
	public void onEnable() {
		...
		requireItem = config.getBoolean("RequireItemForTravel");
		requiredItem = config.getInt("RequiredItemForTravel");
