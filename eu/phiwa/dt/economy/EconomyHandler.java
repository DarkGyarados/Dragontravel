...
public class EconomyHandler {
	...
	public boolean setupEconomy() {
		RegisteredServiceProvider<Economy> economyProvider = server
	...
	public static boolean chargePlayer(Player player) {
		...
		DragonTravelMain.Economy.withdrawPlayer(name,
				DragonTravelMain.config.getDouble("PayTravel"));
	...
	public static boolean chargePlayerTravelPlayer(Player player) {
		...
		String msg = MessagesLoader.replaceColors(withdrawmessage);
		String msgm = msg.replace("%amount%", String
				.valueOf(DragonTravelMain.config.getDouble("PaytoPlayer")));
		player.sendMessage(msgm);
	...
	public static boolean chargePlayerCoordsTravel(Player player) {
		...
		DragonTravelMain.Economy.withdrawPlayer(name,
				DragonTravelMain.config.getDouble("PayCoords"));

		String msg = MessagesLoader.replaceColors(withdrawmessage);
		String msgm = msg.replace("%amount%",
				String.valueOf(DragonTravelMain.config.getDouble("PayCoords")));
		player.sendMessage(msgm);
	...
	public static boolean chargeFlightTravel(Player player) {
		...
		DragonTravelMain.Economy.withdrawPlayer(name,
				DragonTravelMain.config.getDouble("PayFlight"));

		String msg = MessagesLoader.replaceColors(withdrawmessage);
		String msgm = msg.replace("%amount%",
				String.valueOf(DragonTravelMain.config.getDouble("PayFlight")));
		player.sendMessage(msgm);
		return true;
	}
}
