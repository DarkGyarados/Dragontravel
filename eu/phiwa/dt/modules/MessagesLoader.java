...
public class MessagesLoader extends JavaPlugin {
	...
	public void initMessages() {
		...
		DragonTravelMain.messagesFile = new File("plugins/DragonTravel",
				"messages.yml");
		...
		try {
			...
			System.out
					.println("[DragonTravel] Error while initializing Messages-File");
			e.printStackTrace();
		}
	...
	private void firstRun() throws Exception {
		...
		copy(getClass().getResourceAsStream("messages.yml"),
				DragonTravelMain.messagesFile);
	...
	public void loadMessages() {
		try {
			...
			if (!(checkMessagesFileVersion(DragonTravelMain.messages
					.getDouble("MessagesVersion")))) {
				DragonTravelMain.instance.getPluginLoader().disablePlugin(
						DragonTravelMain.instance);
				return;
			}
