...
public class Stations {
	...
	public static void setDestination(Player player, String name) {
		...
		if (DragonTravelMain.dbd.hasIndex(name)) {
			...
			player.sendMessage(MessagesLoader
					.replaceColors(DragonTravelMain.messages
							.getString("DestinationCreatingAlreadyExists")));
			return;
		}
		...
		if (name.length() > 15) {
			...
			player.sendMessage(MessagesLoader
					.replaceColors(DragonTravelMain.messages
							.getString("DestinationCreatingNameTooLong")));
			return;
		}
		...
		player.sendMessage(MessagesLoader
				.replaceColors(DragonTravelMain.messages
						.getString("DestinationCreatingSuccessful"))
				+ " " + name);
	}
	...
	public static void setStation(Player player, String name) {
		...
		if (DragonTravelMain.dbs.hasIndex(name)) {
			...
			player.sendMessage(MessagesLoader
					.replaceColors(DragonTravelMain.messages
							.getString("StationCreatingAlreadyExists")));
			return;
		}
		...
		if (name.length() > 15) {
			...
			player.sendMessage(MessagesLoader
					.replaceColors(DragonTravelMain.messages
							.getString("StationCreatingNameTooLong")));
			return;
		}
		...
		player.sendMessage(MessagesLoader
				.replaceColors(DragonTravelMain.messages
						.getString("StationCreatingSuccessful"))
				+ " " + name);
	}
	...
	public static void removeDestination(CommandSender sender, String name) {
		...
		if (!DragonTravelMain.dbd.hasIndex(name)) {
			...
			sender.sendMessage(MessagesLoader
					.replaceColors(DragonTravelMain.messages
							.getString("DestinationRemovingDoesNotExist")));
			return;
		}
		...
		sender.sendMessage(MessagesLoader
				.replaceColors(DragonTravelMain.messages
						.getString("DestinationRemovingSuccessful"))
				+ " " + name);
	...
	public static void removeStation(CommandSender sender, String name) {
		...
		if (!(DragonTravelMain.dbs.hasIndex(name))) {
			...
			sender.sendMessage(MessagesLoader
					.replaceColors(DragonTravelMain.messages
							.getString("StationRemovingDoesNotExist")));
			return;
		}
		...
		sender.sendMessage(MessagesLoader
				.replaceColors(DragonTravelMain.messages
						.getString("StationRemovingSuccessful"))
				+ " " + name);
	...
	public static boolean checkStation(Player player) {
		...
		Vector locvaca = new Location(world, locplayer.getX(),
				locplayer.getY(), locplayer.getZ()).toVector();
		...
		for (String name : DragonTravelMain.dbs.getIndices()) {
			...
			if (!world.toString().equalsIgnoreCase(
					DragonTravelMain.dbs.getString(name, "world"))) {
				if (amount == 1) {
					CommandHandlers.dtpCredit(player);
					player.sendMessage(MessagesLoader
							.replaceColors(DragonTravelMain.messages
	...
	public static void showDestinations(Player player) {
		...
		player.sendMessage(MessagesLoader
				.replaceColors(DragonTravelMain.messages
						.getString("DestinationShowList")));

		// Adding destinations names to builder - Only destinations from the
		// same world
		// are added to the builder
